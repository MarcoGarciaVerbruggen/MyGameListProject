...
import GameListC from "./optionC/GameListC.jsx";
import GameDetailC from "./optionC/GameDetailC.jsx";
import PersonalTrackerC from "./optionC/PersonalTrackerC.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/OptionC" element={<GameListC />} />
        <Route path="/OptionC/game/:id" element={<GameDetailC />} />
        <Route path="/OptionC/tracker" element={<PersonalTrackerC />} />
      </Routes>
    </BrowserRouter>
  );
}
